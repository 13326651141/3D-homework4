	...
	void OnGUI ()
    {
        ...
        if (game_start)
        {
            ...
            if (life == 0)
            {
                ...
                GUI.Label(new Rect(Screen.width / 2 - 10, Screen.width / 2 - 200, 50, 50), "Higest scores:", text_style);
        ...
        else
        {
            ...
            GUI.Label(new Rect(Screen.width / 2 - 150, Screen.width / 2 - 220, 400, 100), "UFO appearance，shouting at them,just start the battle", text_style);
